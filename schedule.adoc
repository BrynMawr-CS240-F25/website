...
* link:assts/assts3A.html[Assignment 3A: Hardware simulator I] Due {ASST3A_DUE}

| 
* link:lectures/Lecture-Week06-Oct7-MachineCode.pdf[Lecture - Oct 7, Oct 9]
...
* link:assts/asst3B.html[Assignment 3B: Hardware simulator II] Due {ASST3B_DUE}
* Lab: CPU and Computer design, Check-ins

| 
* link:studyguide01.html[StudyGuide]
* link:lectures/Lecture-Week08-Oct21-CPUDesign.pdf[Lecture - Oct 21]
...
* Read: _Elements of Computing Systems_, Chapter 6-7
* Lab: Assembly to machine code translation, Check-ins

| 
* link:lectures/Lecture-Week09-Oct28-Assembler.pdf[Lecture - Oct 28]
* link:lectures/Lecture-Week09-Oct30-VM.pdf[Lecture - Oct 30]
...
* link:assts/asst04.html[Assignment 04: Assembler] Due {ASST05_DUE}
* Lab: Assembler check-ins

| 
* link:lectures/Lecture-Week10-Nov4-VM2.pdf[Lecture - Nov 4]
* link:lectures/Lecture-Week10-Nov6-VMPractice.pdf[Lecture - Oct 30]
...
* Read: _Elements of Computing Systems_, Chapter 9, 10
* link:asst/asst05.html[Assignment 05: Virtual Machine]: Due {ASST05_DUE} (with milestone deliverable on Nov 17)
* Lab: From VM to assembly worksheet

| 
* link:lectures/Lecture-Week11-Nov11-HLL.pdf[Lecture - Nov 11]
* link:lectures/Lecture-Week11-Nov13-Compilation.pdf[Lecture - Nov 13]
...
| 
* link:lectures/Lecture-Week12-VM_Function_Worksheet.pdf[VM Function Worksheet - Nov 18]
* link:lectures/Lecture-Week12-Nov20-Compilation2.pdf[Lecture - Nov 20]
...
* Read: _Elements of Computing Systems_, Chapter 10-11
* link:assts/project.html[Final Project: Compiler and software]: Due {ASST07_DUE}
...
* Midterm 02, Thursday In-class {MIDTERM02} (80 min)
