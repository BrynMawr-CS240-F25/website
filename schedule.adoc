...
| 
* link:lectures/Lecture-Week06-Oct7-MachineCode.pdf[Lecture - Sept 30, Oct 2]
...
|*Midterm, Assembly Compiler*

* Midterm 01: In-class {MIDTERM01_WK8} (1.5 hrs)
* Read: _Elements of Computing Systems_, Chapter 6
* link:assts/assts3B.html[Assignment 3B: Hardware simulator II] Due {ASST04_DUE}
