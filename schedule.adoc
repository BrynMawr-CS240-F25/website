...
* Topics: Virtual machinei: VM code specification, working with stack expressions and virtual memory segments
...
* link:[Project: Virtual Machine]: Due {ASST06_DUE} (with milestone deliverables)
* Lab: VM practice
...
* Read: _Elements of Computing Systems_, Chapter 10-11
* link:[Final Project: Compiler and software]: Due {ASST07_DUE}
