...
* Topics: Hack hardware design, machine language
* Read: _Elements of Computing Systems_ link:https://www.nand2tetris.org/course[Chapters 1-5] 
...
* Topics: von Neumann Architecture revisited
* Read: _Elements of Computing Systems_ link:https://www.nand2tetris.org/course[Chapter 6] 
