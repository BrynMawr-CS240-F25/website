...
* Prof. Normoyle's office hours on Friday Nov 7 will be virtual. Please reach out over slack for an appointment.
* link:assts/asst04.html[Assignment 04] is due Monday, Nov 10th, no extensions
