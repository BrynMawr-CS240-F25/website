...
* Midterm II will be during class on Dec 4th: 80 minutes. You may bring one cheat sheet. link:studyguide02.html[Study Guide]
* link:assts/project.html[Final Project] is due Sunday, Dec 14th, with milestones due Dec 11th (Thursday) and Dec 12th (Friday) 
